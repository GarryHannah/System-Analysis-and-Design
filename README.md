...
Getting each part to work together, reading the file correctly, storing the data, and making sure the output looked correct were hard. When something didn’t work, I slowed down and tested one piece at a time with small examples until I could spot what was wrong. This course helped me get more comfortable with planning before coding and choosing a data structure for a reason, not just because it works.
